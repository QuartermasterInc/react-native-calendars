...
class Calendar extends Component {
  ...
  _handleDayInteraction(date, interaction, isWeekend) {
    ...
    if (
      ...
      !(isWeekend && this.props.weekendDisabled) &&
      !(!isWeekend && this.props.weekdayDisabled)
    ) {
  ...
  pressDay(date, isWeekend) {
    this._handleDayInteraction(date, this.props.onDayPress, isWeekend);
  }

  longPressDay(date, isWeekend) {
    this._handleDayInteraction(date, this.props.onDayLongPress, isWeekend);
  }
    ...
    return (
      <View style={{ flex: 1, alignItems: 'center' }} key={id}>
        <DayComp
          ...
          onPress={date => this.pressDay(date, isWeekend)}
          onLongPress={date => this.longPressDay(date, isWeekend)}
          date={dateAsObject}
